...
| RAG 知识库 | 内置 39 份安全手册（加固清单、应急手册、CVE 速查、取证溯源、日志分析、赛事规则等），BM25 中文检索问答，可选 LLM 增强 |
...
### RAG 知识库
- **内置手册**：39 份（加固清单、应急手册、CVE 速查、取证溯源、工控安全、日志分析、事件日志取证、赛事规则与计分、Flag 防护等），随二进制打包，开箱即用。
